    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createBoardElements() {
            ...
            elmPauseScreen.innerHTML = "<div style='padding:10px;'>Pausado<p/>Pressione [espaço] para retomar.</div>";

            elmAboutPanel = document.createElement("div");
            elmAboutPanel.className = "snake-panel-component";
            elmAboutPanel.innerHTML = "Celso Dinaroski Neto";
            ...
            elmHighscorePanel.innerHTML = "Pontuação: " + (localStorage.jsSnakeHighScore || 0);
        ...
        function createWelcomeElement() {
            ...
            if (config.fullScreen) {
                fullScreenText = "No Windows, pressione F11 para jogar no modo tela cheia.";
            }
            welcomeTxt.innerHTML = "Snake Game<p></p>Use as <strong>setas</strong> do teclado para jogar o jogo. " + fullScreenText + "<p></p>";
            var welcomeStart = document.createElement("button");
            welcomeStart.appendChild(document.createTextNode("Jogar"));
        ...
        function createTryAgainElement() {
            return createGameEndElement("Você morreu :(", "sbTryAgain", "snake-try-again-dialog");
        }
        ...
        */
        me.foodEaten = function() {
            elmLengthPanel.innerHTML = "Tamanho: " + mySnake.snakeLength;
            if (mySnake.snakeLength > localStorage.jsSnakeHighScore)
            {
                localStorage.setItem("jsSnakeHighScore", mySnake.snakeLength);
                elmHighscorePanel.innerHTML = "Pontuação: " + localStorage.jsSnakeHighScore;
            }
